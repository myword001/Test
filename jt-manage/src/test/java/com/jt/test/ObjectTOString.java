...
public class ObjectTOString {
	...
	public void testObj() throws IOException {
		...
		desc.setItemDesc("描述信息");
		desc.setCreated(new Date());
		desc.setUpdated(desc.getCreated());
	...
	public void testList() throws IOException {
		...
		desc1.setItemId(1000L);
		desc1.setItemDesc("描述信息");
		desc1.setCreated(new Date());
		desc1.setUpdated(desc1.getCreated());
		ItemDesc desc2 = new ItemDesc();
		desc2.setItemId(1000L);
		desc2.setItemDesc("描述信息");
		desc2.setCreated(new Date());
		desc2.setUpdated(desc2.getCreated());
